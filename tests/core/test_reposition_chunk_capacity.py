...
def test_occurrence_retry_materializes_final_pages_without_sharing_source(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    def compare_retry(source: torch.Tensor, target: torch.Tensor) -> int:
    ...
    monkeypatch.setattr(radix_kernel, "fast_compare_retry_radix_records", compare_retry)
